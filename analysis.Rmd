...
The out of sample error rate is estimated at approximately 3% for the prediction. Furthermore, this indicates that from 20 samples, about one is predicted to the wrong class.